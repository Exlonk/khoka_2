...
header = [
            html.Img(src="/assets/header.webp",className="header-image center-image large-image"),
            html.Img(src="/assets/header_m.webp",className="header-image center-image small-image"),
         ]
